...
RcppExport SEXP _SynIntTestExact_random_gamma(SEXP aSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _SynIntTestExact_rejection_sampler(SEXP X1SEXP, SEXP X2SEXP, SEXP pen_paramSEXP, SEXP delta_sqSEXP, SEXP tau1sqSEXP, SEXP tau2sqSEXP, SEXP cov1SEXP, SEXP cov2SEXP, SEXP prec1SEXP, SEXP prec2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SynIntTestExact_sigmasq_sampler(SEXP RSEXP, SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SynIntTestExact_maineffects_sampler(SEXP RSEXP, SEXP XSEXP, SEXP Psi_invSEXP, SEXP sigma_sqSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type R(RSEXP);
...
RcppExport SEXP _SynIntTestExact_pot_MALA(SEXP RSEXP, SEXP X1SEXP, SEXP X2SEXP, SEXP paramSEXP, SEXP S1SEXP, SEXP S2SEXP, SEXP sigma_sqSEXP, SEXP delta_sqSEXP, SEXP rej_objSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type R(RSEXP);
...
RcppExport SEXP _SynIntTestExact_grad_MALA(SEXP RSEXP, SEXP X1SEXP, SEXP X2SEXP, SEXP paramSEXP, SEXP S1SEXP, SEXP S2SEXP, SEXP sigma_sqSEXP, SEXP delta_sqSEXP, SEXP rej_objSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type R(RSEXP);
...
RcppExport SEXP _SynIntTestExact_sq_sampler(SEXP RSEXP, SEXP X1SEXP, SEXP X2SEXP, SEXP S1SEXP, SEXP S2SEXP, SEXP sigma_sqSEXP, SEXP delta_sqSEXP, SEXP old_paramSEXP, SEXP eps_MALASEXP, SEXP precond_matSEXP, SEXP precond_mat_invSEXP, SEXP L_HMCSEXP, SEXP rej_objSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type R(RSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_SynIntTestExact_random_gamma", (DL_FUNC) &_SynIntTestExact_random_gamma, 1},
    {"_SynIntTestExact_rejection_sampler", (DL_FUNC) &_SynIntTestExact_rejection_sampler, 10},
    {"_SynIntTestExact_sigmasq_sampler", (DL_FUNC) &_SynIntTestExact_sigmasq_sampler, 2},
    {"_SynIntTestExact_maineffects_sampler", (DL_FUNC) &_SynIntTestExact_maineffects_sampler, 4},
    {"_SynIntTestExact_pot_MALA", (DL_FUNC) &_SynIntTestExact_pot_MALA, 9},
    {"_SynIntTestExact_grad_MALA", (DL_FUNC) &_SynIntTestExact_grad_MALA, 9},
    {"_SynIntTestExact_sq_sampler", (DL_FUNC) &_SynIntTestExact_sq_sampler, 13},
    {"_SynIntTestExact_SIDsampler_draws_adaptive_optimized", (DL_FUNC) &_SynIntTestExact_SIDsampler_draws_adaptive_optimized, 26},
    {NULL, NULL, 0}
};

RcppExport void R_init_SynIntTestExact(DllInfo *dll) {
